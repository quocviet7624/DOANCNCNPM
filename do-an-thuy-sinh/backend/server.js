...
const shippingRoutes = require('./routes/ShippingRoutes'); // ← MỚI
...
app.use('/api/shipping', shippingRoutes); // ← MỚI
...
server.listen(PORT, () => {
    ...
    console.log(`🚚 Shipping API: /api/shipping`); // ← MỚI
});