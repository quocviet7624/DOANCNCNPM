        ...
        <div style={{ display: 'flex', gap: '0', alignItems: 'flex-start', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: '0 0 280px', paddingRight: '48px', borderRight: '1px solid rgba(6,182,212,0.15)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              {[
                { icon: <FaFacebookF size={14}/>, hoverBg: '#1877F2', label: 'Facebook', href: 'https://www.facebook.com/share/186GxkDwdy/?mibextid=wwXIfr' },
                { icon: <FaInstagram size={14}/>, hoverBg: 'linear-gradient(135deg,#f09433,#dc2743,#bc1888)', label: 'Instagram', href: 'https://instagram.com' },
                { icon: <FaYoutube size={14}/>, hoverBg: '#FF0000', label: 'YouTube', href: 'https://youtube.com' },
                { icon: <FaTiktok size={14}/>, hoverBg: '#010101', label: 'TikTok', href: 'https://tiktok.com' },
              ].map(({ icon, hoverBg, label, href }, i) => (
                <a key={i} href={href} aria-label={label} title={label}
            ...
            {['Privacy Policy', 'Terms of Service', 'Sitemap'].map((label, i) => (
              <button key={i}
                style={{
                  ...
                  cursor: 'pointer', letterSpacing: '0.5px', transition: 'color 0.2s', padding: 0,
                }}
